...
import posterImage from "../../images/poster.jpg"; // Corrected path: go up two directories to reach /images/
      ...
      {isOpen && (
        <div
          className={`md:hidden backdrop-blur-sm ${
            isDarkMode ? "bg-white/95" : "bg-gray-900/95"
          }`}
        >
